<img src="https://github.com/Zloyhan/MakeBoxPowerShell/raw/main/Logo.png" alt="MakeBoxPowerShell Logo" width="200">
...
**MakeBox** is a PowerShell console command module designed to simplify your development workflow. It gives you quick, easy-to-use commands for common tasks — so you can focus on writing code, not wrestling with complicated setup processes or long console commands.
...
- **Template Management** - Save any folder as a project template, then use and edit these templates for future projects
